    ...
    public class Player
    {
        ...
        public void ClashEnemyAndBullet(Enemy enemy)
        {
            for (int i = 0; i < 20; i++)
            {
                ...
                if (playerBullet[i].fire == true)
                {
                    if (playerBullet[i].y == enemy.enemyY)  //y축이 같고
                    {
                        if (playerBullet[i].x >= (enemy.enemyX - 1) &&   //x축이 -1< <1 사이일때
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                if (playerBullet2[i].fire == true)
                {
                    if (playerBullet2[i].y == enemy.enemyY)  //y축이 같고
                    {
                        if (playerBullet2[i].x >= (enemy.enemyX - 1) &&   //x축이 -1< <1 사이일때
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                if (playerBullet3[i].fire == true)
                {
                    if (playerBullet3[i].y == enemy.enemyY)  //y축이 같고
                    {
                        if (playerBullet3[i].x >= (enemy.enemyX - 1) &&   //x축이 -1< <1 사이일때
